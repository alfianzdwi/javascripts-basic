//Promise Any mirip dengan Promise Race mengembalikan nilai Promise dengan eksekusi tercepat, namun jika yang tercepat Rejected maka akan diganti dengan yg tercepat ke 2
...
Promise.any([promiseReject1, promiseReject2, promiseReject3])
 ...
 .catch((error) => console.log(error.message)); // Jika semua Promise statusnya Rejected makan akan mengembalikan nilai 'All promises were rejected'